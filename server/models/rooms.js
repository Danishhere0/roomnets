...
const Rooms = new Schema({
    ...
    minimum_stay: String,
    maximum_stay: String,
    amenities_swim: {type:Boolean,default:false},
    amenities_internet: {type:Boolean,default:false},
    amenities_play_ground: {type:Boolean,default:false},
    amenities_parking_space: {type:Boolean,default:false},
    amenities_entry_disabled: {type:Boolean,default:false},
    amenities_balcony: Boolean,
    amenities_others: Boolean,
    amenities_private_toilets: {type:Boolean,default:false},
