  ...
  return (
    <div className="blog-wrap wow fadeInUp">
      <div className="blog-image">
        <div>{masonry ? <img src={"./public/assets/images/blog/"+ data.imagUri} className="bg-img img-fluid" alt="" /> : <Img src={"./public/assets/images/blog/"+ data.imagUri} className="bg-img img-fluid" alt="" />}</div>
