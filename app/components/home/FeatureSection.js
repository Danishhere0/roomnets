                          ...
                          <Col xl="4" lg="3">
                            <div className="feature-left">
                              <div className="property-details">
                                <span className="font-roboto">{data.building_location}</span>
                                <Link href={`/apartment_det/?id=${data._id}`}>
                                  <h3 className="d-flex">
                                    {data.title}
                                    <span>
                                      <span className="label label-dark label-pill">{data.street_name}</span>
                                    </span>
                                  </h3>
                                </Link>
                                <h6>${data.price}*</h6>
                                <p className="font-roboto">{data.advert_description}</p>
                                <ul>
                                  <li>
                                ...
                                <div className="property-btn">
                                  <Link href={`/apartment_det/?id=${data._id}`} className="btn btn-dashed btn-pill" tabIndex="0">
                                    Details
                                  </Link>
                                </div>
                              </div>
