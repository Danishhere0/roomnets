...
const InputForm = ({ label, lg, sm, lastSm }) => {
  ...
  return (
    ...
    <Row className="gx-3">
        ...
        <RangeInputFields label="Rent" name="rent" filterValues={filterValues} setFilterValues={setFilterValues} min={100} max={300000} lg={lg} sm={sm} />
        <RangeInputFields label="Area" name="area" filterValues={filterValues} setFilterValues={setFilterValues} min={30}  max={10000} lg={lg} sm={sm} /> 
        <Col lg={lg || 12}>
