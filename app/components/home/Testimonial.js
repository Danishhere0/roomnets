...
const TestimonialSection = ({ value, normal, ClientTestimonialShortDescript }) => {
        ...
        <Row>
          <Col>
            <div className="title-1 text-white">
              <span className="label label-gradient">Our Happy Customers</span>
              <h2>{ClientTestimonialShortDescript.content}</h2>
              <hr />
            </div>
            <NoSsr>
                    ...
                    <div key={i}>
                      <div className="client-slider light-bg">
                        <ul className="user-list">
                          <li>
                            <img src={"/assets/images/testimonial/"+ `${data.image || ""}`} alt="" />
                          </li>
                          <li>
