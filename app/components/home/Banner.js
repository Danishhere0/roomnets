...
import { BannerDetail, BrowseProperty, BuyOrSell, Roomnets, SubmitProperty } from "../../constValues/constValues";
        ...
        <Row>
          <Col>
            <div className="title-1">
              <span className="label label-gradient">Get a Room mate or Get a Room</span>
            </div>
            <div className="light-bg banner-1">
              ...
              <div className="button-banner">
                <Link href="/post_ad" className="btn btn-gradient">
                  Post a Free Ad
                </Link>
                <Link href="/browse_rooms" className="btn btn-white">
